                ...
                <div id="sidebar-left" class="span2">
                    <div class="nav-collapse sidebar-nav">
                        <ul class="nav nav-tabs nav-stacked main-menu">
                            ...
                            <li><a href="brand_location.php"><i class="icon-envelope"></i><span class="hidden-tablet"> Brand / Location</span></a></li>
                            <li><a href="contact.php"><i class="icon-tasks"></i><span class="hidden-tablet">Contact</span></a></li>
                            <li><a href="about.php"><i class="icon-eye-open"></i><span class="hidden-tablet">About us</span></a></li>
                            <li><a href="users.php"><i class="icon-dashboard"></i><span class="hidden-tablet"> User Info</span></a></li>
                            <li>
