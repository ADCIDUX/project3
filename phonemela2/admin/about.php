...
extract($_POST);	
	$sql="update contents set title='$title', content='".mysql_real_escape_string($content)."' where id=1";
	mysql_query($sql);
...
<?php echo $row[2];?>
	...
	<div class="control-group">
			<div class="controls">
				<input class="btn btn-large btn-success" name="about_save" type="submit" value="SAVE" />
			</div>
		</div>		
	</form>
